...
| [`aisearch-aks-ilb-private-apim`](./scenarios/aisearch-aks-ilb-private-apim/) | Azure AI Search가 사설 AKS ILB와 통신하는 BP — SPL이 LB/AKS 미지원이므로 APIM Standard v2(인바운드 PE + 아웃바운드 VNet 통합)를 `Gateway` group으로 중개 |
